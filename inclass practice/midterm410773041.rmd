...
```{r ans1b2}
str_sub(hwGrades$學號, start = 2, end = 4)
```
...
ymd(hwSubmit3) ->hwSubmit3
difftime(hwSubmit3,deadline) ->hwSubmit3$截止時差
hwSubmit3
```
